<%@ page language="java" import="java.util.*,com.fzu.userBean.Teacher,com.fzu.userBean.MyCourseBean" pageEncoding="utf-8"%>
<%
					...
					<div class="panel panel-default">
					    ...
					    <div id="collapseOne" class="panel-collapse collapse <% if(option.equals("info")) %><%="in" %>" role="tabpanel" aria-labelledby="headingOne">
					      	<div class="panel-body">
					        	<a class="stu-option" href="./servlet/teacher/Teaoption?option=info">个人信息</a>
					      	</div>
					    </div>
				  	</div>
				  	<div class="panel panel-default">
					    ...
					    <div id="collapseTwo" class="panel-collapse collapse <% if(option.equals("choSubject")) %><%="in" %>" role="tabpanel" aria-labelledby="headingTwo">
					     	<div class="panel-body">
					        	<a class="stu-option" href="./servlet/teacher/Teaoption?option=mySubject">课程信息</a>
					      	</div>
					    </div>
				  	</div>
				  	<div class="panel panel-default">
					    ...
					    <div id="collapseThree" class="panel-collapse collapse <% if(option.equals("repswd") || option.equals("logout")) %><%="in" %>" role="tabpanel" aria-labelledby="headingThree">
					     	<div class="panel-body">
					     		<ul class="stu-option">
					        		<li><a class="stu-option" href="./servlet/teacher/Teaoption?option=repswd">修改密码</a></li>
					        		<li><a class="stu-option" href="./servlet/teacher/Teaoption?option=logout">安全退出</a></li>
					      		</ul>
					      	</div>
				  		</div>
				  	</div>
  			...
  			<div class="col-md-8">
  				<div class="classify">
					...
					<%
							...
							List<Teacher> tea = (List<Teacher>)Session.getAttribute("userINFO");
						...
						<tbody>
							<tr>
								...
								<td colspan=2 rowspan=4 class="upload-image">
									...
									<img  class="images" src = "./images/<%=teacher.getTimages() %>" />
								</td>
							</tr>
							<tr>
								<td>姓名拼音</td>
					...
					<%
							...
							List<MyCourseBean> course = (List<MyCourseBean>)Session.getAttribute("userCourse");
					%>
